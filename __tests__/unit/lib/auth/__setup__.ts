...
jest.mock("@aws-sdk/client-cognito-identity-provider", () => {
  return {
    ...
    InitiateAuthCommand: jest.requireActual("@aws-sdk/client-cognito-identity-provider")
      .InitiateAuthCommand,
    RevokeTokenCommand: jest.requireActual("@aws-sdk/client-cognito-identity-provider")
      .RevokeTokenCommand,
  }
})
